...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   handleClickSquare: () => (/* binding */ handleClickSquare)\n/* harmony export */ });\nfunction handleClickSquare(event) {\n  var square = event.target;\n  var _square$dataset = square.dataset,\n    board = _square$dataset.board,\n    x = _square$dataset.x,\n    y = _square$dataset.y;\n  console.log(\"Clicked on \".concat(board, \" board at x: \").concat(x, \", y: \").concat(y));\n}\n\n//# sourceURL=webpack://my-webpack-project/./src/utils/eventHandlers.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   renderBoard: () => (/* binding */ renderBoard)\n/* harmony export */ });\n/* harmony import */ var _eventHandlers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./eventHandlers */ \"./src/utils/eventHandlers.js\");\n\nvar playerBoard = document.getElementById('player-board');\nvar computerBoard = document.getElementById('computer-board');\nfunction renderBoard(player) {\n  var board = player === 'player' ? playerBoard : computerBoard;\n  board.classList = 'board';\n  var newBoard = document.createElement('div');\n  newBoard.classList.add('board');\n  newBoard.id = \"\".concat(player, \"-board\");\n  for (var y = 0; y < 10; y++) {\n    for (var x = 0; x < 10; x++) {\n      var playerSquare = document.createElement('div');\n      playerSquare.classList.add('square');\n      playerSquare.dataset.board = player;\n      playerSquare.dataset.x = x;\n      playerSquare.dataset.y = y;\n      playerSquare.addEventListener('click', function (event) {\n        return (0,_eventHandlers__WEBPACK_IMPORTED_MODULE_0__.handleClickSquare)(event);\n      });\n      board.appendChild(playerSquare);\n    }\n  }\n}\n\n//# sourceURL=webpack://my-webpack-project/./src/utils/rendering.js?");
